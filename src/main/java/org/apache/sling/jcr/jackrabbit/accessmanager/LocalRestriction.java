...
public class LocalRestriction {
    ...
    public boolean equals(Object obj) {
        ...
        if (rd == null) {
            if (other.rd != null) return false;
        } else if (other.rd == null) {
            return false;
        } else if (!rd.getName().equals(other.rd.getName())) return false;
     ...
     */
    public static @NotNull LocalRestriction cloneWithNewValues(
            @NotNull LocalRestriction lr, @NotNull Value[] newValues) {
